...
def new_sheet(name: str):
    ...
    heur_sheet["D1"].value = "Time"
    heur_sheet["E1"].value = "Num Unfeasibilities"
    heur_sheet["F1"].value = "Solution Value"
...
for file in os.listdir(dir_path):
    ...
    with open(filepath, 'r') as fr:
        ...
        if data["heuristic"] == False:
            ...
            heur_sheet["D" + str(indexes[j_heur])].value = data["heuristic - time"]
            heur_sheet["E" + str(indexes[j_heur])].value = data["heuristic - num unfeasibilities"]
            heur_sheet["F" + str(indexes[j_heur])].value = data["heuristic - value"]
